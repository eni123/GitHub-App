...
import { faTachometerAlt,faLayerGroup,faServer,faFileInvoice,faChartLine,faUserCircle,faTag,faShekelSign } from '@fortawesome/free-solid-svg-icons'
...
export default connect(mapStateToProps,{showUser})(SideBar)